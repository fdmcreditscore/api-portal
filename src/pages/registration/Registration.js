              ...
              <CCardBody className="p-4">
                <CForm>
                  ...
                  <CInputGroup className="mb-3">
                    ...
                    <CFormInput placeholder="Company Address" />
                  </CInputGroup>
                  ...
                  <CInputGroup className="mb-3">
                    ...
                    <CFormInput placeholder="Business Registration ID / SIUPP" />
                  </CInputGroup>
                  ...
                  <CInputGroup className="mb-3">
                    ...
                    <CFormInput placeholder="Tax ID / NPWP" />
                  </CInputGroup>

                  <CInputGroup className="mb-3">
                    <CInputGroupText>@</CInputGroupText>
                    <CFormInput placeholder="Person Name" />
                  </CInputGroup>
